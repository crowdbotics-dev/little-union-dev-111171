"""
Django settings for little_union_dev_111171 project.
...
ROOT_URLCONF = 'little_union_dev_111171.urls'
...
WSGI_APPLICATION = 'little_union_dev_111171.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "little_union_dev_111171 API",
    "DESCRIPTION": "API documentation for little_union_dev_111171 App",
    "VERSION": "v1",
}
